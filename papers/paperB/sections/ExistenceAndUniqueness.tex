...
\begin{thm}[{
	...
	Let \Cref{ass:OSLCIntroduction} holds. Then for all $y(0)=y_0\in \mathbb{R}^d$ given, there exist a 
...
\begin{lem}[
	...
	Under \Cref{ass:OSLCIntroduction}, for each $p\geq 2$, there is a $C=C(p,T)$ such that
	\begin{equation*}
