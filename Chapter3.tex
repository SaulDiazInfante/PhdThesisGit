...
\begin{document}
	\begin{frontmatter}
		\title{
			Convergence and asymptotic stability of the explicit Steklov
		...
		\begin{abstract}
			...
			one-half order. A linear version of the Steklov average supports our new solver. 
			Also, we study the almost sure asymptotic stability, and in  order to emphasize the 
	...
	\end{frontmatter}
		...
		\tableofcontents
		\pagebreak
		\import{papers/paperA/sections/}{abstract.tex}
	\section{Introduction} \label{sec1}
		\import{papers/paperA/sections/}{introduction.tex}
	\section{Steklov Method}\label{sec2}
		\import{papers/paperA/sections/}{SteklovMethod.tex}
	\section{Strong consistency and convergence}\label{sec3}
	...
	\begin{appendices}
		...
		\section{Properties of Approximations}
		\input{Preliminaries/ApproximationPrperties}
	\end{appendices}
	\section*{\refname}
